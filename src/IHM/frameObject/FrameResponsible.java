 ...
 * @author Rachid_2
 */
public class FrameResponsible extends javax.swing.JFrame {

    /**
     * Creates new form FrameResponsible
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameResponsible.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameResponsible().setVisible(true);
            }
        });
    }
